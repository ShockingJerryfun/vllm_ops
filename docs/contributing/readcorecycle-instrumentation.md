...
- generated Triton launchers use `base+0=prepare`, `base+1=submit`, and
  `base+2=independent total`; fixed bases 300, 310, 320, 330, 340, 350,
  360, 370, 380, and 390 map by exact generated launcher name to the
  embedding/norm, Q/K-Norm/RoPE, residual/RMSNorm, and SiLU groups, while
  dynamically classified Graph-external launchers use 500 through 580;
